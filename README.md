...
I care more about understanding *why* a system is designed a certain way than getting it to run. That shows up in how I build.

---

## 🔨 What I'm Working On

Currently working through a personalized learning path focused on backend engineering, distributed systems, microservices, and cloud-native development. Building progressively complex projects in ASP.NET Core, PostgreSQL, Docker, RabbitMQ, and Kubernetes.

**[Flowgate](https://github.com/GerhardLemmer/Testing-Platform)** *(on hold)* — A scenario-driven workflow simulation platform that simulates real business workflows — loan approvals, payment flows, order fulfilment — with rule-based pass/fail logic. Built with FastAPI, React 19, PostgreSQL, and Keycloak. On hold while I build deeper backend fundamentals.
...
📧 glemmer94@gmail.com · [LinkedIn](https://www.linkedin.com/in/gerhard-lemmer-17103226b/)
